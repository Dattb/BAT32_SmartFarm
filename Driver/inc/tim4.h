...
#define RD_PWM_PERIOD				16000
#define	RD_PWM_DUTY_PERSCENT(x)		(1.0*x/100*RD_PWM_PERIOD)
/*
...
typedef enum 
{
	...
	TM4_CH0_INPUT_TMIOB0 		= (0x20U), /* TMIOB0 */
	TM4_CH0_INPUT_TMIOD0 		= (0x40U), /* TMIOD0 */
	TM4_CH0_INPUT_TMIOA1 		= (0x60U), /* TMIOA1 */
	TM4_CH0_INPUT_TMIOC1 		= (0x80U), /* TMIOC1 */
	TM4_CH0_INPUT_TMIOB1 		= (0xA0U), /* TMIOB1 */
	TM4_CH0_INPUT_TMIOD1 		= (0xC0U), /* TMIOD1 */
	TM4_CH0_INPUT_TMIOC0 		= (0xE0U), /* TMIOC0 */
